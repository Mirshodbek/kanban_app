...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "inputError": MessageLookupByLibrary.simpleMessage("Проверьте ввод"),
        "login": MessageLookupByLibrary.simpleMessage("Войти"),
        "noAccount": MessageLookupByLibrary.simpleMessage("Нет аккаунта"),
        "noUser":
            MessageLookupByLibrary.simpleMessage("Нет подходящий пользователя"),
        "repositories": MessageLookupByLibrary.simpleMessage("Репозитори"),
        "searchUser":
